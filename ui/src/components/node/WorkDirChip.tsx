 ...
 *  terminal-style completing combobox (shared with ReviewsView's watched-
 *  sources editor via ../common/DirCombobox). Owns its own error state (the
 *  daemon's 400 for a bad path is user-actionable) rather than routing
 *  through NodeView's action error; server validation stays the source of
 *  truth on commit. */
