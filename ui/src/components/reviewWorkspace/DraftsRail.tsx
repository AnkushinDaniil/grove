...
/** Pending drafts, collected in one place. Rendered as the lower section of
 *  the review workspace's right column (the AI-findings panel sits above it);
 *  these are exactly what SubmitBar sends when the review is submitted. */
